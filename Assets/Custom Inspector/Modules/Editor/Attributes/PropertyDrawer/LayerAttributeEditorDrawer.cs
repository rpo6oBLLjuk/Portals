        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (!string.IsNullOrEmpty(l.requiredName))
            {
                ...
                else
                {
                    ...
                    {
                        y = position.y + DrawProperties.messageBoxStartSpacing,
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (!string.IsNullOrEmpty(l.requiredName))
            {
                ...
                if (req == -1 || req != property.intValue)
                    return DrawProperties.messageBoxStartSpacing + DrawProperties.messageBoxHeight + EditorGUIUtility.singleLineHeight;
                else
